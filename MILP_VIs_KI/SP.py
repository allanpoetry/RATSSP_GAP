...
def SP(Yij_list_2, arrival_time, F, F_weight, F_path, F_speed, Path_list, d, M, rw_separation_matrix, distance_matrix, separation_matrix):
    ...
    Delay_time_list = []
    for i in F:
        Delay_time_list.append(D[i].x)

    return_list = [objective_value, Delay_time_list]
